...
const InvoiceLayout = ({id}: {id: string}) => {
const [products, setProducts] = useState<Product[]>([]);
    ...
    const fetchInvoice = async () => {
        try {
            ...
            if (res.data) {
                ...
                const _listOrder = _.cloneDeep(listOrder);
                _params.customer_name = res.data?.customer?.name;
                _params.customer_phone = res.data?.customer?.phone;
    ...
    const handleUpdateInvoice = async () => {
        ...
        try {
            setLoading(true);
            const res = await invoicesAPI.updateInvoice(id, _params);
            if (res.data) {
                messageApi.open({
                    type: 'success',
                    content: 'Cập nhật hóa đơn thành công',
                });
            ...
            messageApi.open({
                type: 'error',
                content: 'Cập nhật hóa đơn không thành công',
            });
            console.log(error);
